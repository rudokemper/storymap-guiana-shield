var config = {
    ...
    chapters: [
        ...
        },	
        {
            ...
            title: 'Suriname / Kwamalasamutu: The Trio People Towards Autonomous and Sustainable Management of Territory',
            image: 'images/kwamala.jpg',
            description: 'As the center of Trio leadership, Kwamalasamutu has great opportunities but also great challenges, common to the entire Trio territory and all of southern Suriname as a whole (as shown on the map as the headwaters of the Marowijne and Corantijn watersheds). Today, the process of recognition of collective rights, absent in Surinamese legislation and within which is the right to land, is firmly advancing, but this implies that communities must be prepared for the exercise of these rights--that is, to carry out autonomous and sustainable management of the territory, to develop community management and planning instruments, and to continue developing territorial control exercises, based on community monitoring initiatives, sustainable production, indigenous healthcare, and self-governance.',
            location: {
